...
const registerPage = () => {
  const formElements = [
    ...
    },
    {
      ...
      type: "text",
      name: "thumbnail",
      placeholder: "Pega el link de tu imagen de perfil",
    },
    {
      label: "Contraseña",
      type: "password",
  ...
  return (
    <section className="section w-screen h-screen flex justify-center items-center flex-col">
      <Link href={"http://localhost:3000"}>
        {" "}
        <p className="text-2xl absolute top-10 left-2/4 -translate-x-1/2 hover:underline">
          Go back to <span className=" font-semibold">Quizzy</span>
        </p>{" "}
      </Link>
